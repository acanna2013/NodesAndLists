...
public class Restaurant
{
   ...
   public static void print(ListNode list)
   {
	...
	{
		while (list.getNext() != null && nodeCount(list) % 2 !=0) {
			list.setNext(list.getNext().getNext());
			list = list.getNext();
		} 
		while (list != null && nodeCount(list) % 2 ==0) {
			list.setNext(list.getNext().getNext());
			list = list.getNext();
		} 
	}
...
//
//	//this method will set the value of every xth node in the list
//	public static void setXthNode(int x, Comparable value)
//	{
//		list = temp;
//		int count = 0;
//		while (list != null && nodeCount() % 2 !=0) {
...
//
//	//this method will remove every xth node in the list
//	public static void removeXthNode(int x)
//	{
//		setXthNode(x, null);
//		list = temp;
//
